/*
Package gokb is a pure Go Postgres driver for the database/sql package.
...
using this package directly. For example:
	...
	func main() {
		connStr := "user=system dbname=samples sslmode=verify-full"
...
You can also connect to a database using a URL. For example:
	...
	connStr := "kingbase://system:password@localhost/samples?sslmode=verify-full"
...
Use single quotes for values that contain whitespace:
    ...
    "user=system password='with spaces'"
...
The kbpass mechanism as described in http://www.postgresql.org/docs/current/static/libpq-pgpass.html
...
When imported, additional connection string parameters are supported:
	...
	* krbsrvname - GSS (Kerberos) service name when constructing the
	  SPN (default is `kingbase`). This will be combined with the host
